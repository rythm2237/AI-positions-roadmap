...
const workspaceFixture={slug:"ai-test",title:"AI Test",category:"AI",shortDescription:"Test career",difficulty:"Beginner",estimatedLearningTime:"1 month",lastUpdated:"2026-08-01",visual:{nodeLabel:"Test",sceneTitle:"Test",sceneDescription:"Test",imageAlt:"Test"},overview:{title:"Overview",body:"Body",responsibilities:[],industries:[]},journeyMap:{theme:"treasure-map",overviewTitle:"Journey",overviewDescription:"Description"},journeyStages:[{id:"start",title:"Start",test:{questions:[{}]}}],roadmap:[{}],projects:[],globalResources:[],mapSections:[],progressRules:{readinessThreshold:80},finalChallenge:{title:"Challenge"},jobBoard:{title:"Jobs"},interviewPrep:{title:"Interview"}};
