...
export interface JobAgent {
  ...
  english_only_priority: boolean; exclude_unknown_languages: boolean; work_authorization: string | null; sponsorship_requirement: string | null;
  notice_period: string | null; earliest_start_date: string | null; employment_types: string[]; industries: string[]; preferred_companies: string[]; excluded_companies: string[];
...
export interface ApplicationRecord {
  ...
  job_opportunities?: Pick<JobOpportunity, "company" | "role" | "location" | "country" | "job_url" | "fit_score" | "source" | "founder_positioning" | "decision_status" | "snoozed_until"> | null;
}
