...
const catalog = [
  ...
  ["generative-engine-optimization-specialist", "Generative Engine Optimization (GEO) Specialist", "AI Marketing", "Improve trusted visibility, retrieval, citation, and authority across generative answer engines through research, entities, evidence, technical discoverability, and measurement."],
