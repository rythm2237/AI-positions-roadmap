...
const catalog = [
  ...
  ["ai-integration-specialist", "AI Integration Specialist", "AI Automation", "Connect AI services safely to applications, data, workflows, and enterprise platforms through secure interfaces, governed context, resilient orchestration, evaluation, and production operations.", "available", "/careers/ai-integration-specialist?entry=galaxy"],
  ...
  ["ai-transformation-consultant", "AI Transformation Consultant", "Enterprise AI & Consulting", "Guide enterprises from fragmented AI activity to a governed, executable, adopted, and measurable transformation through diagnosis, opportunity portfolios, operating models, roadmaps, workforce change, and value realization.", "available", "/careers/ai-transformation-consultant?entry=galaxy"],
