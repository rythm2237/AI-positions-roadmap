export const CAREER_DOMAINS = ["AI Engineering", "AI Product", "AI Automation", "Enterprise AI & Consulting", "AI Data & Analytics", "AI Infrastructure & Security", "AI Marketing"] as const;
export type CareerDomain = (typeof CAREER_DOMAINS)[number];
export type CareerAvailability = "available" | "planned";
export interface CareerCatalogEntry { id: string; slug: string; title: string; domain: CareerDomain; description: string; availability: CareerAvailability; route?: string; displayOrder: number; }
...
const catalog = [
  ...
  ["ai-product-manager", "AI Product Manager", "AI Product", "Guide useful, responsible AI products from customer problem through delivery and evaluation."],
  ["ai-automation-engineer", "AI Automation Engineer", "AI Automation", "Engineer dependable automations that connect AI models, APIs, data, and business workflows."],
  ["intelligent-automation-engineer", "Intelligent Automation Engineer", "AI Automation", "Combine process engineering, automation platforms, and AI to improve complex operations."],
  ...
  ["ai-workflow-architect", "AI Workflow Architect", "AI Automation", "Design scalable human-and-AI workflows with clear controls, handoffs, and outcomes."],
  ["ai-solutions-consultant", "AI Solutions Consultant", "Enterprise AI & Consulting", "Translate business needs into practical, trustworthy AI solution designs."],
...
export const CAREER_CATALOG: readonly CareerCatalogEntry[] = catalog.map((entry, index) => ({ id: entry[0], slug: entry[0], title: entry[1], domain: entry[2], description: entry[3], availability: (entry[4] ?? "planned") as CareerAvailability, route: entry[5], displayOrder: index + 1 }));
