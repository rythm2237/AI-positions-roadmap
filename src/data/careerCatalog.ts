...
const catalog = [
  ...
  ["cloud-engineer", "Cloud Engineer", "AI Infrastructure & Security", "Design, build, secure, automate, monitor, and optimize cloud infrastructure and platform services for reliable digital and AI-enabled workloads.", "available", "/careers/cloud-engineer?entry=galaxy"],
