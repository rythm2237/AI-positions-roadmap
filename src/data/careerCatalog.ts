...
const catalog = [
  ...
  ["business-ai-consultant", "Business AI Consultant", "Enterprise AI & Consulting", "Identify high-value AI opportunities and translate them into measurable business change, governed solutions, adoption plans, and value realization.", "available", "/careers/business-ai-consultant?entry=galaxy"],
  ["enterprise-ai-consultant", "Enterprise AI Consultant", "Enterprise AI & Consulting", "Advise large organizations on enterprise AI strategy, portfolio investment, architecture, governance, sourcing, operating models, adoption, and responsible scale.", "available", "/careers/enterprise-ai-consultant?entry=galaxy"],
  ...
  ["bi-developer", "BI Developer", "AI Data & Analytics", "Build governed semantic models, reliable transformations, performant dashboards, and decision-ready business intelligence products.", "available", "/careers/bi-developer?entry=galaxy"],
  ["data-engineer", "Data Engineer", "AI Data & Analytics", "Design, build, test, secure, and operate reliable data platforms and pipelines for analytics, operations, and production AI.", "available", "/careers/data-engineer?entry=galaxy"],
  ...
  ["ai-knowledge-engineer", "AI Knowledge Engineer", "AI Data & Analytics", "Structure, govern, retrieve, evaluate, and maintain organizational knowledge for reliable AI assistants, search, RAG, and agents.", "available", "/careers/ai-knowledge-engineer?entry=galaxy"],
  ...
  ["devops-engineer", "DevOps Engineer", "AI Infrastructure & Security", "Build reliable delivery, infrastructure, observability, security, and operational systems for cloud and AI-enabled software.", "available", "/careers/devops-engineer?entry=galaxy"],
