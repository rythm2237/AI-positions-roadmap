...
const catalog = [
  ...
  ["microsoft-copilot-consultant", "Microsoft Copilot Consultant", "AI Automation", "Design, deploy, govern, and drive adoption of Microsoft Copilot and Copilot Studio solutions across business workflows."],
  ...
  ["cloud-engineer", "Cloud Engineer", "AI Infrastructure & Security", "Design, build, secure, automate, monitor, and optimize cloud infrastructure and platform services for reliable digital and AI-enabled workloads."],
  ...
  ["generative-engine-optimization-specialist", "Generative Engine Optimization (GEO) Specialist", "AI Marketing", "Improve trusted generative discovery through query intelligence, entity architecture, evidence-led content, technical accessibility, authority, and rigorous measurement.", "available", "/careers/generative-engine-optimization-specialist?entry=galaxy"],
