  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#03050e] text-white">
      ...
      <main>
        <section className="relative isolate overflow-hidden px-5 pb-20 pt-32 sm:px-8 sm:pb-28 sm:pt-40">
          ...
          <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
            <div className="max-w-3xl">
              ...
              <h1 id="homepage-title" className="mt-7 font-display text-5xl font-bold tracking-[-.045em] text-white sm:text-6xl lg:text-7xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/careers" className="inline-flex items-center justify-center rounded-xl bg-white px-5 py-3.5 text-sm font-semibold text-slate-950 transition hover:bg-violet-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400">
        ...
        <section id="how-it-works" className="scroll-mt-24 border-y border-white/[0.06] bg-white/[0.015] px-5 py-20 sm:px-8 sm:py-24">
        ...
        <section id="career-universe-section" className="scroll-mt-20 border-y border-white/[0.06] bg-white/[0.012] px-5 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="overflow-hidden rounded-[2rem] border border-white/[0.08] bg-[#03050e] shadow-[0_30px_100px_rgba(0,0,0,.35)]">
              <SafeCareerUniverse />
            </div>
          </div>
        </section>

        <section id="waitlist" className="scroll-mt-24 px-5 py-20 sm:px-8 sm:py-28">
      ...
      <footer className="border-t border-white/[0.06] px-5 py-8 sm:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav className="flex flex-wrap gap-x-5 gap-y-2" aria-label="Footer navigation">
            <Link href="/careers" className="transition hover:text-slate-300">Careers</Link>
