...
export default async function JobRecommendationPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ error?: string }> }) {
  ...
  return <main className="mx-auto max-w-4xl px-5 py-10 sm:py-12">
    ...
    {query.error === "not-eligible" ? <p role="alert" className="mt-5 rounded-xl border border-amber-300/20 bg-amber-400/[.06] p-4 text-sm text-amber-100">This vacancy is not eligible for application preparation under your current Job Agent rules.</p> : null}
