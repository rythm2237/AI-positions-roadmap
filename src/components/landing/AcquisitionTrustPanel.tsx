    ...
    <aside className="pointer-events-none absolute left-4 top-[88px] z-20 sm:left-6 lg:left-8">
      {!open ? (
        ...
        <div className="pointer-events-auto w-[min(92vw,470px)] rounded-2xl border border-white/10 bg-slate-950/88 p-4 shadow-2xl backdrop-blur-xl sm:p-5">
          ...
          <p className="mt-4 border-t border-white/10 pt-3 text-[10px] leading-5 text-slate-600">No invented testimonials, hiring rates or Before → After stories are published. Verified outcome proof is added only from real users and auditable product data.</p>
        </div>
      )}
    </aside>
  );
