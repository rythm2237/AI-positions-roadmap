...
export default function AdminNavigation() {
  return <aside className="border-b border-white/10 bg-slate-950/90 lg:min-h-screen lg:w-64 lg:border-b-0 lg:border-r">
    ...
    <nav aria-label="Admin Studio" className="flex gap-2 overflow-x-auto px-3 pb-4 lg:block lg:space-y-1">
      ...
      <Link className="block min-h-11 shrink-0 rounded-xl px-3 py-3 text-sm font-semibold text-violet-200 hover:bg-violet-400/[.08] focus-visible:outline focus-visible:outline-2 focus-visible:outline-violet-300" href="/admin/ai-workspace">AI Control Center</Link>
